...
class BouncingBall(): 
    ...
    # def drawball(self, screen, ball_color, x_location, y_location, ball_size):
        # self.screen = screen
...
while not done:
    ...
    ball1 = BouncingBall(7, 10, 5, 6, 10)
    ball1.flashBounce(screen, possible_ball_colors, 500, 700)
    pygame.draw.circle(screen, possible_ball_colors, 20,30,15)
